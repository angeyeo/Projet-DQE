...
if os.getenv("DATABASE_URL"):
    ...
    # Développement local : SQLite reste disponible si DATABASE_URL n'est pas défini.
    DATABASES = {
        "default": {
...
# Frontend React et backend Django sont sur deux domaines différents en production.
